...
if __name__ == "__main__":
    ...
    login_url = "http://jwgl.hzau.edu.cn/xtgl/login_slogin.html?language=zh_CN&_t="
    # 请求PublicKey的URL
    login_KeyUrl = "http://jwgl.hzau.edu.cn/xtgl/login_getPublicKey.html?time="
    # 登录后的课表URL
    table_url = "http://jwgl.hzau.edu.cn/kbcx/xskbcx_cxXsKb.html?gnmkdm=N2151"

    zspt = Longin("2017307211017", "2017kshzkjdx", login_url, login_KeyUrl)
